    ...
    <div class="container mx-auto p-8">
        ...
        <form action="{{ route('cars.store') }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input id="equipment" type="text" name="equipment" value="{{ old('equipment') }}" required
                       class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                @error('equipment')
                    <span class="text-red-500 text-xs italic">{{ $message }}</span>
                @enderror
        ...
        <form action="{{ route('cars.index') }}" method="GET" class="mb-4">
            <div class="flex items-center space-x-4">
                <input type="text" name="search" value="{{ request('search') }}" placeholder="Search by model" class="border border-gray-300 p-2 rounded-md w-1/3">
            ...
            <thead class="bg-gray-800 text-white">
                <tr>
                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">
                        <a href="{{ route('cars.index', ['sort' => 'mark', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc']) }}">Mark</a>
                    </th>
                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">
                        <a href="{{ route('cars.index', ['sort' => 'model', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc']) }}">Model</a>
                    </th>
                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">
                        <a href="{{ route('cars.index', ['sort' => 'year', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc']) }}">Year</a>
                    </th>
                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">
                        <a href="{{ route('cars.index', ['sort' => 'vin', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc']) }}">VIN</a>
                    </th>
                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">
                        <a href="{{ route('cars.index', ['sort' => 'color', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc']) }}">Color</a>
                    </th>
                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">
                        <a href="{{ route('cars.index', ['sort' => 'mileage', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc']) }}">Mileage</a>
                    </th>
                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">
                        <a href="{{ route('cars.index', ['sort' => 'price', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc']) }}">Price</a>
                    </th>
                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">
                        <a href="{{ route('cars.index', ['sort' => 'availability', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc']) }}">Availability</a>
                    </th>
                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">
                        <a href="{{ route('cars.index', ['sort' => 'body_type', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc']) }}">Body Type</a>
                    </th>
                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">
                        <a href="{{ route('cars.index', ['sort' => 'equipment', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc']) }}">Equipment</a>
                    </th>
                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">
                        <a href="{{ route('cars.index', ['sort' => 'engine', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc']) }}">Engine</a>
                    </th>
                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">
                        <a href="{{ route('cars.index', ['sort' => 'tax', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc']) }}">Tax</a>
                    </th>
                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">
                        <a href="{{ route('cars.index', ['sort' => 'transmission', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc']) }}">Transmission</a>
                    </th>
                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">
                        <a href="{{ route('cars.index', ['sort' => 'drive_type', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc']) }}">Drive Type</a>
                    </th>
                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">
                        <a href="{{ route('cars.index', ['sort' => 'delivery_location', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc']) }}">Delivery Location</a>
                    </th>
